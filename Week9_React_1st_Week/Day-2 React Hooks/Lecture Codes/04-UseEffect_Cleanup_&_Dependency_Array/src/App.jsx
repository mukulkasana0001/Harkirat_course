...
function Counter(props) {
    ...
    useEffect(
        function () {
            ...
            // Return a cleanup function that logs after 'props.count1' changes   (means when useEffect call then on first time it do nothing but  for second time it cleanup the first original thing and for third time it cleanup the second time changed things  and so on  )
            return function () {
