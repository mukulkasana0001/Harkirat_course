...
function Counter() {
    ...
    //(first renter = lifecycle event = mount)(lifecycle event's are mounting , re-rendring, un-mounting)
    //we don't use useEffect on every render we use it on mounting(means on first time mount)
    useEffect(() => {    // we can also say thet we guard our setInterval from re-renders
